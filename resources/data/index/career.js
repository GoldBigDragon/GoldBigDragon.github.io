const DATA_CAREER = [
	...
	},
	{
		...
		"task": {
			...
			"kr":"<ul style='margin-bottom: 0rem;'><li>MITRE ATT&CK 프레임워크 기반 훈련 시나리오 연구 및 개발</li><li>Chainlaysis Reactor 기반 암호화폐 추적</li><li>Chainlaysis IAPI 기반 암호화폐 추적 서비스 개발</li><li>vSphere 기반 Learning Management System (LMS) 유지보수</li><li>Spring Boot 기반 Web Application Server (WAS) 개발</li></ul>",
